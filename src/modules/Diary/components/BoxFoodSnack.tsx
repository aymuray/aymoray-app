...
const BoxFoodSnack = ({ title, onPress }) => {
  ...
  const getRecipe = async () => {
    ...
    try {
      ...
      if (recipes.length != temp.length) {
        let sumaCalTemp= temp[0].data.Recetas.snack.primerElemento.Cals + temp[0].data.Recetas.snack.segundoElemeto.Cals;
        setRecipes(temp);
      ...
      <View backgroundColor={Colors.white}>
        ...
        {recipes.length == 1 ?
            <View>
              ...
              <ItemIngredient dataRecipe={recipes[0].data.Recetas.snack.primerElemento}/>
              <View height={1} backgroundColor={Colors.line} />
